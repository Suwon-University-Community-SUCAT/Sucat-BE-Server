...
public class MessageController {
    ...
    public void message(@DestinationVariable("room-id") UUID roomId, MessageDto messageDto) {
    ...
    public ResponseEntity<ApiResponse<Object>> getMessages(@PathVariable("room-id") UUID roomId,
